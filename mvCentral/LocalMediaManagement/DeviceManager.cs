...
namespace mvCentral.LocalMediaManagement {
    ...
    public class DeviceManager {
        ...
        public static void StartMonitor() {
            ...
            mvCentralCore.DatabaseManager.ObjectInserted += new DatabaseManager.ObjectAffectedDelegate(onPathAdded);
        ...
        public static void StartDiskWatcher() {
            lock (syncRoot) {
                if (mvCentralCore.Settings.DeviceManagerEnabled && !MonitorStarted) {
