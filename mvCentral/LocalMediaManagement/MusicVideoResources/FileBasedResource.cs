...
namespace mvCentral.LocalMediaManagement.MusicVideoResources
{
    public class FileBasedResource {
        ...
        protected bool Download(string url) {
            int maxRetries = mvCentralCore.Settings.MaxTimeouts;
            int timeoutBase = mvCentralCore.Settings.TimeoutLength;
            int timeoutIncrement = mvCentralCore.Settings.TimeoutIncrement;
        ...
        private DownloadStatus Download(string url, long startPosition, int timeout) {
            ...
            try {
                ...
                request.UserAgent = mvCentralCore.Settings.UserAgent;
