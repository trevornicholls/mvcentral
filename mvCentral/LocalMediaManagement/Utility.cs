...
namespace mvCentral.LocalMediaManagement {
    ...
    class Utility {
        ...
        public static DirectoryInfo GetMusicVideoBaseDirectory(DirectoryInfo directory) {
        ...
        #region MusicVideoHash
        
        public static string GetMusicVideoHashString(string filename) {
