...
namespace mvCentral.Extensions {
    ...
    public static class MusicVideoTitleStringExtensions {
        ...
        public static string ToSortable(this String self) {
            Regex expr = new Regex(@"^(" + mvCentralCore.Settings.ArticlesForRemoval + @")\s(.+)", RegexOptions.IgnoreCase);
        ...
        public static string ToKeywords(this String self) {
            ...
            string newTitle = Regex.Replace(self, @"\b(" + mvCentralCore.Settings.ArticlesForRemoval + @")\b", "", RegexOptions.IgnoreCase);
