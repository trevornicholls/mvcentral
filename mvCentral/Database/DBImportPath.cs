    ...
    public class DBImportPath : mvCentralDBTable {
        ...
        public bool Active {
            get {
                ...
                if (this.GetDriveType() != DriveType.CDRom)
                    ...
                    return mvCentralCore.Settings.AutomaticallyImportDVDs;
             }
        }
        ...
        public List<DBLocalMedia> GetLocalMedia(bool returnOnlyNew) {
            ...
            try {
                ...
                if (mvCentralCore.Settings.IgnoreInteractiveContentOnVideoDisc && IsOpticalDrive && InternallyManaged) 
                {
        ...
        public static DBImportPath Get(int id) {
            return mvCentralCore.DatabaseManager.Get<DBImportPath>(id);
        }
        ...
        public static DBImportPath Get(string fullPath) {
            ...
            List<DBImportPath> resultSet = mvCentralCore.DatabaseManager.Get<DBImportPath>(criteria);
        ...
        public static List<DBImportPath> GetAll() {
            return mvCentralCore.DatabaseManager.Get<DBImportPath>(null);
        }
